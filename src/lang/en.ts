...
const en = {
  ...
  home: {
    intro: {
      ...
      description: `'<br/>'
      I am a Mechanical Engineer, Consultant, Dreamer! This is a website I created with the desire to share my knowledge with everyone. Thank you to everyone who visited. ❤️,'<br/>'

Who I Am Today, And How I Got Here'<br/>'

| Curiosity was always my playground.'<br/>'
