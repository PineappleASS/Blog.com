...
const en = {
  ...
  home: {
    intro: {
      ...
      description: `
      <p> I am Mechanical Engineer, Consultant, Dreamer! This is a website I created with the desire to share my knowledge to everyone. Thank you to everyone who visited. ❤️</p>

      <p> Who I Am Today, And How I Got Here </p>
      ...
      <p> So, that's a bit about me. I'm Waleed Alghamdi, and I'm more than just an engineer or a consultant. I'm a guy who loves to learn, help others, and take on whatever challenges come my way.</p>
    `,
